...
Múltiplos Esquemas de Resfriamento (Cooling Schedules): O código explora diferentes funções para a queda da temperatura, incluindo modelos lineares e a função Sigmóide, que apresentou os melhores resultados em termos de convergência.
